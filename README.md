...
1. **Create a virtual environment** (recommended)
   ```bash
   python -m venv kdlvkp_env
   # On Windows: 
   kdlvkp_env\Scripts\activate
   ```
...
3. **Verify the setup**
   - Ensure the `data` folder contains the required CSV files
   - Run a simple test to verify Python can import necessary libraries
